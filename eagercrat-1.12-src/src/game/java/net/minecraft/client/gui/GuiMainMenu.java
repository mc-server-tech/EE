...
public class GuiMainMenu extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new GuiButton(15, this.width / 2 - 100, j + 72 + 36, 98, 20, "Account Login"));
		this.buttonList.add(new GuiButton(16, this.width / 2 + 2, j + 72 + 36, 98, 20, "Friends"));
		this.buttonList.add(new GuiButton(4, this.width / 2 - 100, j + 72 + 60, 200, 20, I18n.format("Edit Profile")));
	...
	protected void actionPerformed(GuiButton button) throws IOException {
		...
		if (button.id == 15) {
			this.mc.displayGuiScreen(new GuiScreenAccountLogin(this));
		}

		if (button.id == 16) {
			if (AccountManager.isLoggedIn()) {
				this.mc.displayGuiScreen(new GuiScreenFriends(this));
			} else {
				this.mc.displayGuiScreen(new GuiScreenAccountLogin(this));
			}
		}
